...
class GATSeq(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        for i in range(num_conv_layers):
            conv_res = self.convs[i](x=h, edge_index=edge_index, edge_attr=edge_attr)
            h = conv_res # do not skip!
